...
class AccountMove(models.Model):
    ...
    #         ('posted', 'Posted'),
    #         ('cancel', 'Cancelled'),
    #     ], string='Status', index=True, readonly=True, tracking=True, default='draft')
    ...
    @api.onchange('state')
    def _onchange_state_print_state(self):
        print('Ha cambiado de estado')
        print(self.state)
    

    @api.onchange('currency_id','account_current_inverse_currency')
    ...
    @api.depends('account_current_currency','account_current_inverse_currency')
    ...
    def onchange_product_id_changeprice(self):
        for record in self:
            ...
            if record.move_id.gif_temp_account > 0:
                print('Se va dividir entre: ',record.move_id.gif_temp_account)
